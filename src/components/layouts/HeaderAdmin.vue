                                ...
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title">Dr. Orali Fisher</span> Schedule <span class="noti-title">her appointment</span></p>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title">Rochel Dickey</span> has booked her appointment to <span class="noti-title">Dr. Orali Fisher</span></p>
